...
<!--
	Two-column learn shell: a sticky sidebar (hidden on mobile) and a fluid content
	column. The sidebar height is viewport-minus-navbar so it can scroll independently
